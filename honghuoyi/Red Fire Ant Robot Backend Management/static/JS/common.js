...
var common_ops = {
    ...
    setMenuIconHighLight:function(){
        ...
        if (pathname.indexOf("/map_yichao") > -1) {
            nav_name = "map_yichao";
        }
    ...
    buildUrl:function(path,params){
        ...
        if(params){
            _paramUrl = Object.keys(params).map(function(k){
                return [encodeURLComponment(k),encodeURLComponment(params[k]).join("=")];
            }).join("&");
...
//        var prefix_url = $(".hidden_layout_wrap input[name=prefix_url]").val();
        ...
        return "http://127.0.0.1:8000/static/upload/" + img_key;
